...
test('from binary works as expected', function(assert) {
  var buf = binary.from('ƒello 淾淾淾 hello world 淾淾 yep ƒuu 淾', 'binary')
    , expect

  expect = [146,101,108,108,111,32,254,254,254,32,104,101,108,108,111,32,119,111,114,108,100,32,254,254,32,121,101,112,32,146,117,117,32,254]
